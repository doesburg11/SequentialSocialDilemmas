...
```bibtex
@misc{leibo2017replication,
  author       = {Van Doesburg, Peter},
  title        = {Multi-Agent RL in Sequential Social Dilemmas: An RLlib New-API-Stack Port with Leibo-Style Dilemma Evaluation},
  year         = {2026},
  publisher    = {GitHub},
  note         = {GitHub repository},
  howpublished = {\url{https://github.com/doesburg11/Leibo2017}}
}
```
